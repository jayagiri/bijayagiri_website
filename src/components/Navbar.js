...
const Navbar = () => {
  return (
    <div className="m-4 b-4">
     <nav className= "flex flex-auto items-center justify-between bg-[#1b2430]">
      ...
      <div>
        <ul className="flex items-center justify-center text-white ">
          <li className="pr-4 relative font-normal hover:font-bold"><a  href="index.html">Home</a></li>
          <li className="pr-4 relative font-normal hover:font-bold"><a  href="index.html">Shop</a></li>
          <li className="pr-4 relative font-normal hover:font-bold"><a  href="index.html">Blog</a></li>
          <li className="pr-4 relative font-normal hover:font-bold"><a  href="index.html">About</a></li>
          <li className="pr-4 relative font-normal hover:font-bold"><a  href="index.html">Contact</a></li>
